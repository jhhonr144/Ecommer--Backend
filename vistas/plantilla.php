...
<html>
    <head>
        ...
        <title>Paarcas | Panel de Control</title>
...
<?php
if (isset($_SESSION["validarSesionBackend"]) && $_SESSION["validarSesionBackend"] === "ok" && $_SESSION["perfil"]==="superadministrador") {
    ...
    echo '</div>';
}else if (isset($_SESSION["validarSesionBackend"]) && $_SESSION["validarSesionBackend"] === "ok" && $_SESSION["perfil"]==="editor") {

    echo '<div class="wrapper">';
    /* =============================================
      CABEZOTE
      ============================================= */
    include "modulos/cabezote_1.php";
    /* =============================================
      LATERAL
      ============================================= */
    include "modulos/lateral_1.php";
    ...
    if (isset($_GET["ruta"])) {
        ...
        if ($_GET["ruta"] == "inicio" ||
            ...
            include "modulos/" . $_GET["ruta"] . "_1.php";
        }
    }
